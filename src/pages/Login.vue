...
<template>
    ...
    <div class="flex justify-center items-center min-h-screen bg-slate-100">
        <div class="w-[643px] shadow-lg">
            <img :src="log" alt="">
            <div class="w-[588px] h-[156px] absolute bg-[#21252B80] rounded-[20px] -translate-y-[250px] ml-[37px]">
                <p class="text-[#E9EAEC] font-semibold text-[26px] w-[556px] text-center ml-4 mt-6">"Welcome to DIAMOND (Digital Administration Monitoring Dashboard)”</p>
            </div>
        </div>
        <div class="w-[720px] h-[1024px] bg-white shadow-lg">
            <div class="w-[480px] h-[496px] mt-[202.5px] ml-[120px]">
                <svg width="252" height="45" class="ml-[114.5px]" viewBox="0 0 252 45" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="mt-8">
                    ...
                    <form action="" class="mt-2">
                        <input type="text" class="w-[480px] h-[40px] border-[1px] outline-none rounded-lg px-3" placeholder="Masukkan username" name="username" id="username">
                    </form>
                </div>
                <div class="mt-6">
                    ...
                    <form action="" class="mt-2 flex absolute">
                        <input :type="isPasswordVisible ? 'text' : 'password'" class="w-[480px] h-[40px] border-[1px] outline-none rounded-lg px-3" placeholder="Masukkan password" name="password" id="password">
                        <svg v-if="!isPasswordVisible" @click="togglePasswordVisibility" width="16" height="17" class="-translate-x-7 mt-[11px] cursor-pointer" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg v-else @click="togglePasswordVisibility" width="16" height="17" class="-translate-x-7 mt-[11px] cursor-pointer" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
