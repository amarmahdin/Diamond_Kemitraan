            ...
            <div class="w-[480px] h-[496px] mt-[202.5px] ml-[120px]">
                ...
                <div class="mt-6">
                    ...
                    <form action="" class="mt-2 flex absolute">
                        ...
                        <svg @click="togglePasswordVisibility" width="16" height="17" class="-translate-x-7 mt-[11px] cursor-pointer" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
