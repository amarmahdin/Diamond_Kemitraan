...
<template>
        <div class="w-[656px] h-[328px] absolute rounded-b-lg -translate-x-[620px] mt-8 bg-white">
            ...
            <div class="w-[656px] h-[252px] border-[1px] rounded-b-lg p-4">
                ...
                <div class="w-[608px] h-[90px] flex mt-6">
                    ...
                    <div class="px-7">
                        <h1 class="text-[#333333] text-lg font-medium">Pengajuan Masuk</h1>
                        <p class="text-[#333333]">Pengajuan (PKS/NDA/MoU) dengan nomor 100123 meminta persetujuan. Silakan tinjau pengajuan pada menu Approval.</p>
                    </div>
                </div>
            </div>
        </div>
